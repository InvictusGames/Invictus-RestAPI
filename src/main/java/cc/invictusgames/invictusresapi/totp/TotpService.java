package cc.invictusgames.invictusresapi.totp;

import cc.invictusgames.invictusresapi.InvictusRestAPI;
import cc.invictusgames.invictusresapi.totp.repository.RedisCredentialRepository;
...
public class TotpService {
    ...
    public TotpService(InvictusRestAPI api) {
        this.api = api;
