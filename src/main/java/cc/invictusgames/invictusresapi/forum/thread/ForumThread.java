package cc.invictusgames.invictusresapi.forum.thread;
...
public class ForumThread {
    ...
    public JsonObject toJson() {
        ...
        if (lastEditedBy != null) {
            profile = InvictusRestAPI.getInstance().getProfileService().getProfile(lastEditedBy).orElse(null);
    ...
    public ForumModel getParent() {
        return forum != null
                ? InvictusRestAPI.getInstance().getForumService().getForumModelService().getById(forum).orElse(null)
                : null;
    }

    public ForumThread getParentThread() {
        return parentThreadId != null
                ? InvictusRestAPI.getInstance().getForumService().getThreadService().getThread(parentThreadId).orElse(null)
                : null;
    }
