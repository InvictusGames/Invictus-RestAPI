...
public class Profile {
    ...
    private static final GrantService GRANT_SERVICE = InvictusRestAPI.getInstance().getGrantService();
    private static final PunishmentService PUNISHMENT_SERVICE = InvictusRestAPI.getInstance().getPunishmentService();
    private static final RankService RANK_SERVICE = InvictusRestAPI.getInstance().getRankService();
