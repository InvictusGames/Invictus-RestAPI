...
import cc.invictusgames.invictusresapi.forum.account.ForumAccount;
import cc.invictusgames.invictusresapi.punishment.Punishment;
import cc.invictusgames.invictusresapi.rank.Rank;
import cc.invictusgames.invictusresapi.util.PermissionUtil;
import cc.invictusgames.invictusresapi.util.UUIDCache;
...
public class ProfileController {
    ...
    public ProfileController(InvictusRestAPI api) {
        this.api = api;
    ...
    public ResponseEntity<JsonElement> createProfile(@RequestBody JsonObject body) {
        JsonBuilder response = new JsonBuilder();
        Profile profile = InvictusRestAPI.GSON.fromJson(body, Profile.class);
